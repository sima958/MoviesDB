...
class PopularViewController: BaseViewController {
    ...
    private let movieApi: AbstractNetworkService
    ...
    private lazy var errorBtn: UIButton = {
        ...
        btn.backgroundColor = ColorPicker.white
        btn.tintColor = ColorPicker.black
        btn.layer.cornerRadius = 2.0
        btn.layer.borderWidth = 2.0
        btn.layer.borderColor = ColorPicker.black.cgColor
        return btn
    }()
    ...
    init(movieApi: AbstractNetworkService) {
